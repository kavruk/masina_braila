...
void readkeyboard() {
  ...
  if ((keyboardValue > 70) && (keyboardValue < 90)) {
    keypressed = ENTER_KEY;
  }
  if ((keyboardValue > 145) && (keyboardValue < 156)) {
    keypressed = 7;
  }
  if ((keyboardValue > 220) && (keyboardValue < 228)) {
    keypressed = 4;
  }
  if ((keyboardValue > 280) && (keyboardValue < 290)) {
    keypressed = 1;
  }
  if ((keyboardValue > 350) && (keyboardValue < 360)) {
    keypressed = 0;
  }
  if ((keyboardValue > 420) && (keyboardValue < 430)) {
    keypressed = 8;
  }
  if ((keyboardValue > 490) && (keyboardValue < 500)) {
    keypressed = 5;
  }
  if ((keyboardValue > 570) && (keyboardValue < 582)) {
    keypressed = 2;
  }
  if ((keyboardValue > 660) && (keyboardValue < 672)) {
    keypressed = DEL_KEY;
  }
  if ((keyboardValue > 750) && (keyboardValue < 770)) {
    keypressed = 9;
  }
  if ((keyboardValue > 870) && (keyboardValue < 890)) {
    keypressed = 6;
  }
  if ((keyboardValue > 1010) && (keyboardValue < 1024)) {
    keypressed = 3;
  }
